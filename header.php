...
<html lang="en">
    ...
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" media = "print" href = "<?php bloginfo('template_directory'); ?>/assets/css/print.css">
        ...
        <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/assets/css/style.css?v=<?php echo get_the_time( 'G:i' ) ?>">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                        ...
                        <a class="navbar-brand" href="<?php echo get_site_url(); ?>">
                            ...
                            if($forty_year_logo_header){ ?>
                                <img class="white-logo forty_year_logo_header" alt="<?php bloginfo('name'); ?>" src="<?php echo $forty_year_logo_header; ?>">
                            <?php } ?>

                            <img class="print-logo" src="<?php mmi_opts_show('print-logo'); ?>" alt="<?php bloginfo('name'); ?>" />
                        ...
                        <div class="bannerblock">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="banner-text">                                
                                        ...
                                        <?php if(get_sub_field('slider_rtitle')) { ?>
                                            ...
                                            <p class="h1 animate__animated animate__backInDown"><?php echo get_sub_field('slider_rtitle'); ?></p>

                                        <?php } ?>

                                        <?php if(get_sub_field('home_slider_rshort_cnt')) { ?>

                                            <p class="animate__animated animate__backInUp"><?php echo get_sub_field('home_slider_rshort_cnt'); ?></p>

                                        <?php }                                 

                                        if( have_rows('slider_url') ): 

                                            while( have_rows('slider_url') ): the_row(); 
                                                ...
                                                if( $link ): 
                                                    ...
                                                    <a class="btn-red theme-btn animate__animated animate__backInUp" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="banner-image" style="background-image:url(<?php the_sub_field('slider_rimage'); ?>);">
